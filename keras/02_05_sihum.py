...
# X_pre_ss = ss_csv[-180:].values.reshape(-1, 180,15)  # 삼성전자 데이터
# X_pre_am = am_csv[-180:].values.reshape(-1, 180,15)
...
# print(X_pre_am)   # (1, 180, 15)
# print(X_pre_ss)   # (1, 180, 15)
...
X4 = X[778:2196,]
y2 = y[-1418:,]
# print(X3.shape) # (1418, 180, 15)
# print(X4.shape) # (1418, 180, 15)
# print(y2.shape)  # (1418,)


# X_predict = ss_csv[0:180]
...
model.fit([X1_train, X2_train, X3_train,X4_train],[y1_train, y2_train], epochs=1000, validation_split=0.15, batch_size=1000, verbose=2, callbacks=[es,mcp])
