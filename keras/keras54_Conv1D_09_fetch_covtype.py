...
model= Sequential()
model.add(Conv1D(filters=19,kernel_size=3, input_shape= (18,3)))                                                      
model.add(Flatten())
...
# 로스 :  0.5644089579582214
# ACC :  0.7599567174911499

#Conv1D

# 로스 :  0.6334378123283386
# ACC :  0.7260013222694397
