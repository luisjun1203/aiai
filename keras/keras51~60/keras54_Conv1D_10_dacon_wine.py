...
X = X.values.reshape(5497,12,1)
test_csv = test_csv.values.reshape(1000,12,1)
...
model= Sequential()
model.add(Conv1D(filters=19,kernel_size=3, input_shape= (12,1)))                                                      
model.add(Flatten())
...
submission_csv.to_csv(path + "submission_0130_11_.csv", index=False)
print("로스 : ", results[0])
...
#rnn
# 로스 :  1.1961359977722168
# ACC :  0.4599888026714325

#Conv1D
# 로스 :  1.0911245346069336
# accuracy_score :  0.5204252937884724
