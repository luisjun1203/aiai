...
# d5 = Dense(99,activation='relu')(d4)
# drop1 = Dropout(0.4)(d5)
# d6 = Dense(7)(drop1)
# o1 = Dense(1,activation='sigmoid')(d6)
# model = Model(inputs = i1, outputs = o1)

model= Sequential()
model.add(Conv1D(filters=19,kernel_size=3, input_shape= (10,3)))                                                      
model.add(Flatten())
...
filepath = "".join([path, 'k28_06_cancer_', date,'_', filename])
...
# 로스 :  [0.12130723148584366, 0.9649122953414917]
# R2 :  0.8083026799789806

#rnn
# 정확도 :  0.9692982456140351
# 로스 :  [0.16360846161842346, 0.969298243522644]
# R2 :  0.832264844981608

#Conv1D

# 정확도 :  0.9473684210526315
# 로스 :  [0.12072812765836716, 0.9473684430122375]
# R2 :  0.7124540199684709
