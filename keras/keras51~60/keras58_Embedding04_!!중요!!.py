...
################## Embedding2 ################################
model.add(Embedding(input_dim= 31, output_dim = 100, input_length=1))       # input_length가 1, 5는 돌아가지만 2,3,4,6... 안돼
# input_dim = 31    # 디폴트
...
model.fit(X_pad, y, epochs=1000, batch_size=10,verbose=2, callbacks=[es])
