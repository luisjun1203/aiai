...
hist = model.fit(X_train, y_train, epochs=300, batch_size=700, validation_split=0.197, callbacks=[es])           # early stopping
e_time = time.time()
...
print("mse : ", loss)
# print("R2스코어 : ", r2)
submission_csv.to_csv(path + "submission_0110_777.csv", index=False)
