...
# print(train_csv['hour_bef_temperature'].mean())
# print(train_csv['hour_bef_windspeed'].mean())
# print(train_csv['hour_bef_humidity'].mean())
# print(train_csv['hour_bef_visibility'].mean())
# print(train_csv['hour_bef_ozone'].mean())
# print(train_csv['hour_bef_pm10'].mean())
# print(train_csv['hour_bef_pm2.5'].mean())
...
# submission_csv.to_csv(path + "submission_0106_9.csv", index=False)
