...
X1_train, X1_test, X2_train, X2_test, X3_train, X3_test, y_train, y_test = train_test_split(X1_datasets, X2_datasets, X3_datasets, y, test_size=0.15, random_state=3)
...
model = Model(inputs=[i1,i2, i3], outputs=fo)
...
model.fit([X1_train, X2_train, X3_train], y_train, epochs=1500, batch_size=30)
