...
es = EarlyStopping(monitor='val_loss', mode='min', patience=500, verbose=3)
hist = model.fit(X_train, y_train, epochs=10000, batch_size=700, validation_split=0.15, callbacks=[es])           # early stopping
e_time = time.time()
