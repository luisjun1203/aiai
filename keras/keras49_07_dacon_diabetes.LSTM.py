...
model.add(LSTM(19, return_sequences=True,          
               input_length = 4, input_dim = 2, activation='relu'))         
model.add(LSTM(97, ))                                                       
...
hist = model.fit(X_train, y_train, epochs=1000, batch_size=32, validation_split=0.15, callbacks=[es] )
...
submission_csv.to_csv(path + "submission_0130_1_.csv", index=False)
...
# 로스 :  [0.4102599620819092, 0.8220859169960022]