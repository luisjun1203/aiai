...
X_test = rbs.fit_transform(X_test.reshape(-1, 32*32*3)).reshape(-1, 32, 32, 3)
...
model.fit(X_train, y_train, epochs=50, batch_size=970,verbose=2, validation_split=0.15, callbacks=[es])
end_time = time.time()
