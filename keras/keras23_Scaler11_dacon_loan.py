...
model.fit(X_train, y_train, epochs=10000, batch_size=500, validation_split=0.2, callbacks=[es], verbose=2)
...
submission_csv.to_csv(path + "submission_0118_11_.csv", index=False)