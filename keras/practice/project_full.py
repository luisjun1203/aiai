...
captions = captions.sample(150000) # 123287
...
early_stopping = tf.keras.callbacks.EarlyStopping(patience=3, restore_best_weights=True, monitor = 'val_acc')
...
tts.save("C:/_data/project/temp/tts136481.mp3")
pygame.init()
pygame.mixer.music.load("C:/_data/project/temp/tts136481.mp3")
...
tts.save("C:/_data/project/temp/tts136488.mp3")
pygame.init()
pygame.mixer.music.load("C:/_data/project/temp/tts136488.mp3")
pygame.mixer.music.play()
time.sleep(5)
pygame.quit()

img_path = "d:/_data/coco/archive/coco2017/test2017/000000326379.jpg"
pred_caption = generate_caption(img_path, add_noise=False)
print('Predicted Caption:', pred_caption)
print()
im = Image.open(img_path)
...
tts.save("C:/_data/project/temp/tts326379.mp3")
pygame.init()
pygame.mixer.music.load("C:/_data/project/temp/tts326379.mp3")
pygame.mixer.music.play()
time.sleep(5)
pygame.quit()
...
tts.save("C:/_data/project/temp/tts136146.mp3")
pygame.init()
pygame.mixer.music.load("C:/_data/project/temp/tts136146.mp3")
pygame.mixer.music.play()
time.sleep(5)
pygame.quit()