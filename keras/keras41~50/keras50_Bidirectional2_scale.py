...
from keras.layers import Dense,Dropout, Conv2D,SimpleRNN, LSTM, Bidirectional
...
model = Sequential()
model.add(Bidirectional(LSTM(19, return_sequences=True, activation='relu'), input_shape=(3, 1)))
model.add(Bidirectional(LSTM(97, )))
