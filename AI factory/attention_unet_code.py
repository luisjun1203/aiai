...
# 중간 가중치 저장 이름
CHECKPOINT_PERIOD = 5
CHECKPOINT_MODEL_NAME = 'checkpoint-{}-{}-epoch_{{epoch:02d}}_03_17_01.hdf5'.format(MODEL_NAME, save_name)
 
# 최종 가중치 저장 이름
FINAL_WEIGHTS_OUTPUT = 'model_{}_{}_final_weights_03_17_01.h5'.format(MODEL_NAME, save_name)
...
model.load_weights('C:\\_data\\AI factory\\train_output\\checkpoint-pretrained_attention_unet-base_line-epoch_30_03_18_01.hdf5')
...
joblib.dump(y_pred_dict, 'C:\\_data\\AI factory\\train_output\\y_pred_03_18_02.pkl')
