...
print('가중치 저장')
model.load_weights('C:\\_data\\AI factory\\train_output\\checkpoint-pretrained_attention_unet-sang765-epoch_20.hdf5')
...
joblib.dump(y_pred_dict, 'C:\\_data\\AI factory\\train_output\\sang_03_22_01.pkl')
print("done")