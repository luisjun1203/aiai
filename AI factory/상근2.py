...
# 중간 가중치 저장 이름
CHECKPOINT_PERIOD = 3
CHECKPOINT_MODEL_NAME = 'checkpoint-{}-{}-epoch_{{epoch:02d}}_03_24_01.hdf5'.format(MODEL_NAME, save_name)
 
# 최종 가중치 저장 이름
FINAL_WEIGHTS_OUTPUT = 'model_{}_{}_final_weights_03_24_01.h5'.format(MODEL_NAME, save_name)
...
# Reduce
rlr = ReduceLROnPlateau(monitor='val_loss', patience=5, factor=0.5, mode='min', min_lr = 0.000001)
...
print('가중치 저장')
model.save_weights('C:\\_data\\AI factory\\train_output\\model_MultiResUNet_JUN_final_weights_03_24_01.h5')
print("저장된 가중치 명: multiresunetatt.h5")

model.load_weights('C:\\_data\\AI factory\\train_output\\model_MultiResUNet_JUN_final_weights_03_24_01.h5')
