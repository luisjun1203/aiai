...
# Layer1
w1 = tf.compat.v1.get_variable('w1', shape=[2, 2, 3, 128], initializer=tf.contrib.layers.xavier_initializer()) #kernel 사이즈, 채널, output
...
# Layer4 DNN
w4 = tf.compat.v1.get_variable('w4', shape=[7*7*32, 100], initializer=tf.contrib.layers.xavier_initializer())
