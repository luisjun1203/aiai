# 버전 이슈
# sklearn 1.1.3버전은 되지만 1.3.0버전에서는 안돌아간다
import numpy as np
from sklearn.datasets import load_digits
from sklearn.svm import SVC
from sklearn.experimental import enable_halving_search_cv
from sklearn.model_selection import StratifiedKFold, train_test_split, GridSearchCV, RandomizedSearchCV, HalvingGridSearchCV, HalvingRandomSearchCV
...
model = HalvingRandomSearchCV(SVC(), parameters, cv=StratifiedKFold, verbose=1, n_jobs=-3, random_state=5, factor=2)  # factor : 데이터 양 조절 
...
print(sk.__version__)   #1.1.3  --HalvingRandomSearch() 1.3버전에서는 안돌아감-- 
